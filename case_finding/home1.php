                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response[0]) {
                                ...
                                $("#result_success").html("<div class='col-sm-5'><h5><strong>New Application Detail</strong></h5><span id='new_application_details'></span></div><div class='col-sm-5'><h5><strong>Old Application Detail</strong></h5><span id='old_application_details'></span></div><div class='col-sm-2'><h5><strong>Case Status</strong></h5><span id='case_status'></span></div><br>");
