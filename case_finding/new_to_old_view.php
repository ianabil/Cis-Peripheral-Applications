...
require_once('../connection.php');?>
    ...
    <head>
        <title>Finding Old Application Details</title>
...
<img src="../images/home.png" onClick="location.href='../index.php';" style="float:right;height:50px;;width:50px;cursor: pointer;">
                            <h2 style="background-color:#36648B;padding:30px;color:#ffffff;">FIND OLD APPLICATION DETAILS FOR NEW APPLICATIONS</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-2 ">
                            <label class="control-level">Case Type</label>
                            <br>
                        ...
                        <div class="col-sm-2">
                            <label class="control-level">Case Number</label>
                            <br>
                            <input type="text" class="form-control" id="case_no" name="case_no">
                        </div>

                        <div class="col-sm-2">
                            <label class="control-level">Case Year</label>
                            <br>
                ...
                <div class="row">
                    <div class="col-sm-3"></div>
                    <div class="col-sm-3">
                        <button type="button" class="form-control btn btn-success" id="search">Search</button>
                    </div>
                    <div class="col-sm-3">
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on("click", "#search", function() {
                    ...
                    var casetype_name = $("#case_type option:selected").text();
                    var flag = 1;
                    ...
                    if (isNaN(caseyear)) {
                        $('#case_year').after('<span class="error" style="color:red;">Please type year properly</span>');
                        flag = 0;
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response[0]) {
                                ...
                                $("#result_success").html("<div class='col-sm-4'><h5><strong>New Application Detail</strong></h5><span id='new_application_details'></span></div><div class='col-sm-3'><h5><strong>Old Application Detail</strong></h5><span id='old_application_details'></span></div><div class='col-sm-2'><h5><strong>Main Case Status</strong></h5><span id='case_status'></span></div><div class='col-sm-3'><h5><strong>Application Status</strong></h5><span id='appl_status'></span></div><br>");

                                $("#new_application_details").html("<span style='color:#8B0000;'><strong>" + apptype + " " + appno + " " + "of " + appyear + "</strong></span>" + " in maincase " +
                                    "<span style='color:#8B0000;'><strong>" + casetype_name + " " + caseno + " of " + caseyear + "</strong></span>");
								...
								if(response[0]["disp_name"]==null)
									$("#appl_status").html("");
								else
									$("#appl_status").html("<span style='color:#1ABC9C;'><strong>"+response[0]["disp_name"]+"</strong></span>");
