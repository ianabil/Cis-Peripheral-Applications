                ...
                $(document).on("click", "#search", function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response[0]) {
                                $("#result_success").html("<div class='col-sm-4'><h5><strong>Old Application Detail</strong></h5><span id='old_application_details'></span></div><div class='col-sm-3'><h5><strong>New Application Detail</strong></h5><span id='new_application_details'></span></div><div class='col-sm-2'><h5><strong>Main Case Status</strong></h5><span id='case_status'></span></div><div class='col-sm-3'><h5><strong>Application Status</strong></h5><span id='appl_status'></span></div>");
								...
								$("#new_application_details").html("<span style='color:#8B0000;'><strong>" + response[0]["ia_type_name"] + " " + response[0]["ia_regno"] + " " + "of " + response[0]["ia_regyear"] + "</strong></span>" + " in maincase " +
                                    "<span style='color:#8B0000;'><strong><a href='main_case_view.php?case_type="+response[0]["regcasetype"]+"&case_no="+response[0]["reg_no"]+"&case_year="+response[0]["reg_year"]+"'>" + response[0]["type_name"] + " " + response[0]["reg_no"] + " of " + response[0]["reg_year"] + "</a></strong></span>");
