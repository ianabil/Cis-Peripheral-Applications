...
$name = strtoupper($_POST['name']); // Name
...
// Base Query
$sql="(SELECT DISTINCT CAST(SUBSTRING(caveat_no, 1, 10) as int), caveat_t.caveat_no, caveat_t.petname, caveat_t.resname, caveat_t.cino, caveat_t.dt_filing, caveat_t.time_of_filing, caveat_t.low_case_no, caveat_t.date_of_order, caveat_t.ldec_date, caveat_t.pet_adv, caveat_t.lower_court_district FROM caveat_t LEFT JOIN civ_address_t ON caveat_t.cino = civ_address_t.cino WHERE caveat_t.petname LIKE '%".$name."%' OR caveat_t.resname LIKE '%".$name."%' OR civ_address_t.name LIKE '%".$name."%') 
      UNION ALL (SELECT DISTINCT CAST(SUBSTRING(caveat_no, 1, 10) as int), caveat_t_a.caveat_no, caveat_t_a.petname, caveat_t_a.resname, caveat_t_a.cino, caveat_t_a.dt_filing, caveat_t_a.time_of_filing, caveat_t_a.low_case_no, caveat_t_a.date_of_order, caveat_t_a.ldec_date, caveat_t_a.pet_adv, caveat_t_a.lower_court_district FROM caveat_t_a LEFT JOIN civ_address_t_a ON caveat_t_a.cino = civ_address_t_a.cino WHERE caveat_t_a.petname LIKE '%".$name."%' OR caveat_t_a.resname LIKE '%".$name."%' OR civ_address_t_a.name LIKE '%".$name."%') ORDER BY dt_filing DESC, 1 DESC".$limit_data;
...
(SELECT DISTINCT caveat_t.caveat_no, caveat_t.petname, caveat_t.resname, caveat_t.cino, caveat_t.dt_filing, caveat_t.time_of_filing, caveat_t.low_case_no, caveat_t.date_of_order, caveat_t.pet_adv, caveat_t.lower_court_district FROM caveat_t LEFT JOIN civ_address_t ON caveat_t.cino = civ_address_t.cino WHERE caveat_t.petname ILIKE '%".$name."%' OR caveat_t.resname LIKE '%".$name."%' OR civ_address_t.name LIKE '%".$name."%' 
UNION SELECT DISTINCT caveat_t_a.caveat_no, caveat_t_a.petname, caveat_t_a.resname, caveat_t_a.cino, caveat_t_a.dt_filing, caveat_t_a.time_of_filing, caveat_t_a.low_case_no, caveat_t_a.date_of_order, caveat_t_a.pet_adv, caveat_t_a.lower_court_district FROM caveat_t_a LEFT JOIN civ_address_t_a ON caveat_t_a.cino = civ_address_t_a.cino WHERE caveat_t_a.petname ILIKE '%".$name."%' OR caveat_t_a.resname LIKE '%".$name."%' OR civ_address_t_a.name LIKE '%".$name."%') jj";
...
foreach($rec as $data){
    if(ltrim($data['caveat_no'])!=""){
            ...
            $report['Caveator Name & Address'] = "<b>Name: </b>".$caveator_name .'<br><b>Address: </b>'.$caveator_address;   
            $report['Caveatee Name & Address'] = "<b>Name: </b>".$caveatee_name .'<br><b>Address: </b>'.$caveatee_address;   
            ...
            $report['Advocate Name & Address'] = "<b>Name: </b>".$adv_name."<br><b> Address: </b>".$adv_address."<br><b> Contact No.: </b>".$adv_phone;
            ...
            if(strpos($report['Caveatee Name & Address'],$name)!= false || strpos($report['Caveator Name & Address'],$name)!= false)
                $record[] = $report;
